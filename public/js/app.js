...
document.addEventListener('DOMContentLoaded', function () {
  var addToCart = document.querySelectorAll('.btn1');
  var itemCount = document.querySelector('#itemCount');
  function updateCart(food) {
    axios__WEBPACK_IMPORTED_MODULE_3__["default"].post('/updateCart', food).then(function (res) {
      console.log(res);
  ...
  addToCart.forEach(function (addBtn) {
    addBtn.addEventListener('click', function (e) {
      var food = JSON.parse(addBtn.dataset.add);
      // console.log(e);
      // console.log(addBtn);
      console.log(food);
      updateCart(food);
  ...
  //orderTrack
  var all_status = document.querySelectorAll('.status-line');
  var hidden_status = document.querySelector('#hidden_status');
  var order = hidden_status ? hidden_status.value : null;
  ...
  function updateOrderStatus(order) {
    ...
    all_status.forEach(function (status) {
      var fetched_status = status.dataset.status;
      if (completed) {
